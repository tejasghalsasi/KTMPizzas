...
public class PizzaMargherita extends Activity 
{
	String usrname;
@Override
...
setContentView(R.layout.activity_pizza_margherita);
...
getMenuInflater().inflate(R.menu.pizza_margherita, menu);
return true;
}
}
