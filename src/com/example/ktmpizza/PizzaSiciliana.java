...
public class PizzaSiciliana extends Activity 
{
	String usrname;
	@Override
	...
	setContentView(R.layout.activity_pizza_siciliana);
	setupActionBar();
	...
	getMenuInflater().inflate(R.menu.pizza_siciliana, menu);
	return true;
	}	
}
