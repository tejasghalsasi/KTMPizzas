...
public class PizzaBoscaiola extends Activity 
{
	String usrname;
	...
	setContentView(R.layout.activity_pizza_boscaiola);
	...
	getMenuInflater().inflate(R.menu.pizza_boscaiola, menu);
	return true;
	}
